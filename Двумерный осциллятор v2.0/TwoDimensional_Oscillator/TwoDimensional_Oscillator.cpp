...
// TwoDimensional_Oscillator.cpp : Определяет поведение классов для приложения.
//
...
// создание CTwoDimensional_OscillatorApp
...
// Единственный объект CTwoDimensional_OscillatorApp

CTwoDimensional_OscillatorApp theApp;


// инициализация CTwoDimensional_OscillatorApp
